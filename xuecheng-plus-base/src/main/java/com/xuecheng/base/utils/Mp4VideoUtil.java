...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\software\\ffmpeg\\ffmpeg.exe";
    String video_path = "E:\\下载\\媒资\\avi\\【4K珍藏】张国荣《风继续吹》！经典咏流传！.avi";
    String mp4folder_path = "E:\\下载\\媒资\\张国荣《风继续吹》.mp4";
...
//        clear_mp4(mp4folder_path+mp4_name);
        ...
        List<String> commend = getCommend();
    ...
    private List<String> getCommend() {
