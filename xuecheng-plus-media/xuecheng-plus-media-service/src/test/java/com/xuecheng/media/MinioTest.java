...
public class MinioTest {
    ...
    MinioClient minioClient = MinioClient.builder()
                    .endpoint("http://192.168.100.10:9000")
    ...
    public void testUpload() throws Exception {
        ...
        UploadObjectArgs uploadObjectArgs = UploadObjectArgs.builder()
                ...
                .bucket("testbucket")
                //指定本地文件路径
                .filename("E:\\下载\\媒资\\mp4\\墨染江湖平行世界水墨绘卷 _ 梅隐山庄、十二楼、外八门势力格局展开，少侠亲启！.mp4")
                //对象名 放在子目录下
                .object("/test/aaa/1.mp4")
                //设置媒体文件类型
    ...
    public void testGetFile() throws Exception {
        ...
        //指定输出流
        FileOutputStream outputStream = new FileOutputStream("E:\\下载\\媒资\\minio\\墨染江湖平行世界水墨绘卷 _ 梅隐山庄、十二楼、外八门势力格局展开，少侠亲启！.mp4");

        IOUtils.copy(inputStream, outputStream);


        //校验文件的完整性对文件的内容进行md5
        FileInputStream fileInputStream1 = new FileInputStream("E:\\下载\\媒资\\mp4\\墨染江湖平行世界水墨绘卷 _ 梅隐山庄、十二楼、外八门势力格局展开，少侠亲启！.mp4");
        String source_md5 = DigestUtils.md5Hex(fileInputStream1);
        FileInputStream fileInputStream = new FileInputStream("E:\\下载\\媒资\\minio\\墨染江湖平行世界水墨绘卷 _ 梅隐山庄、十二楼、外八门势力格局展开，少侠亲启！.mp4");
